...
public class Profesor{
    ...
    public Profesor(){Grupos = new List<Grupo>();}

    public Profesor(string nombre, DateTime fechaIng, string materia, string salario, Escuela escuela)=>
    (Nombre, FechaIng, Materia, Salario, Escuela)=(nombre, fechaIng, materia, salario, escuela);
