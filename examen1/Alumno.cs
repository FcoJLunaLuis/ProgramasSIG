...
public class Alumno{
    public Alumno(){Calificaciones = new List<int>();}
    public Alumno(string nomber, int edad, DateTime fechaIng, string becado)=>
    (Nombre, Edad, FechaIng, Becado)=(nomber, edad,fechaIng,becado);
