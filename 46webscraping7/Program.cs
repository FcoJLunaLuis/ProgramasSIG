    ...
    class Program
    {
        ...
        static void Consultas(int nc){
            switch(nc){
                ...
                case 3: {
                    WriteLine("\n\nConsulta 3 - Dada una categoria, imprimir sus libros");
                    int categoriaId = 6;
                    var catLibs = db.Categorias.Select(c=>c).Where(c=>c.CategoriaID==categoriaId).ToList();
                ...
                case 2: {
                    WriteLine("\n\nConsulta 2 - Categorais en base a un criterio - El nombre inicia con una letra especifica");
                    string letra = "A";
                ...
                case 1 : {
                    WriteLine("\n\nConsulta 1 - Todas las categiorias\n");
